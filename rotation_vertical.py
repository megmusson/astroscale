...
gt_euler = read_rotation_data('data/rotation/Viscam-W/10d_rotating_vertical/gt_euls.csv')

est_euler = read_data_from_csv('data/rotation/Viscam-W/10d_rotating_vertical/Mk6_Eul_res.csv')
